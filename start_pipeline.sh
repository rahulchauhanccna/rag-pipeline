...
echo "   python3 data_generators/order_stream_generator.py --mode socket --self-connect"
echo "   (Use --self-connect to test without Flink, or omit it to wait for Flink)"
echo ""
